        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<%=request.getContextPath()%>/home">IFPE Campus Jaboatão - Inscrições Pós-Graduação <small id="passwordHelpBlock" class="form-text text-muted">(v.1.0)</small></a>
            </div>
            <!-- /.navbar-header -->
